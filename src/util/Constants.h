...
enum eRenderColorFormat {
    RENDER_COLOR_FORMAT_RGBA,
    RENDER_COLOR_FORMAT_RGB,
    RENDER_COLOR_FORMAT_ARGB
};

enum eRenderSampleCount {
    RENDER_SAMPLE_COUNT_1,
    RENDER_SAMPLE_COUNT_2,
    RENDER_SAMPLE_COUNT_4,
    RENDER_SAMPLE_COUNT_8,
    RENDER_SAMPLE_COUNT_16,
    RENDER_SAMPLE_COUNT_32,
    RENDER_SAMPLE_COUNT_64,
};

enum eRenderImageUsage {
    RENDER_IMAGE_USAGE_SAMPLED,
    RENDER_IMAGE_USAGE_STORAGE,
    RENDER_IMAGE_USAGE_COLOR_ATTACHMENT,
    RENDER_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT,
    RENDER_IMAGE_USAGE_INPUT_ATTACHMENT,
    RENDER_IMAGE_USAGE_TRANSIENT_ATTACHMENT,
    RENDER_IMAGE_USAGE_FRAGMENT_SHADING_RATE_ATTACHMENT,
    RENDER_IMAGE_USAGE_FRAGMENT_DENSITY_MAP,
    RENDER_IMAGE_USAGE_VIDEO_DECODE_DST,
    RENDER_IMAGE_USAGE_VIDEO_DECODE_DPB,
    RENDER_IMAGE_USAGE_VIDEO_ENCODE_SRC,
    RENDER_IMAGE_USAGE_VIDEO_ENCODE_DPB
};

enum eRenderImageLayout {
    RENDER_IMAGE_LAYOUT_UNDEFINED,
    ...
    RENDER_IMAGE_LAYOUT_PREINITIALIZED
};

enum eRenderImageTiling {
    RENDER_IMAGE_TILING_OPTIMAL,
    RENDER_IMAGE_TILING_LINEAR
};

enum eRenderSharingMode {
    RENDER_SHARING_MODE_EXCLUSIVE,
    RENDER_SHARING_MODE_CONCURRENT
};
...
enum eRenderWrapMode {
    RENDER_WRAP_MODE_REPEAT,
    RENDER_WRAP_MODE_MIRRORED_REPEAT,
    RENDER_WRAP_MODE_CLAMP_TO_EDGE,
    RENDER_WRAP_MODE_MIRROR_CLAMP_TO_EDGE,
    RENDER_WRAP_MODE_CLAMP_TO_BORDER
};
