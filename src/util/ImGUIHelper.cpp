...
void ImGUIHelper::Initialize() {
    ...
    // ImGui_ImplSDL3_InitForVulkan(Window::GetContext());

    // ImGui_ImplVulkan_InitInfo init_info = {};
    // init_info.Instance = RenderSystem::sInstance;
    // init_info.PhysicalDevice = *RenderSystem::GetGPU();
    // init_info.Device = *RenderSystem::GetDevice();
    // init_info.QueueFamily = RenderSystem::GetGPU()->GetQueueFamilies().m_graphics.value();
    // init_info.Queue = RenderSystem::GetDevice()->GetGraphicsQueue();
